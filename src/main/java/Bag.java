...
public abstract class Bag {
    ...
    public String popItem() {
        ...
        int last_index = this.numberOfContents - 1;
        String to_return = this.contents[last_index];
        this.contents[last_index] = null;
        numberOfContents -= 1;
    ...
    public void increaseCapacity(int n) {
        ...
        this.contents = Arrays.copyOf(this.contents, this.capacity + n);
        this.capacity += n;
    }
